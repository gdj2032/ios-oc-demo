...
@interface SlidingTabbarViewController ()

@end

@implementation SlidingTabbarViewController
...
- (void)tabBarControllerAddChildViewController
{
    ...
    classControllers = @[@"Demo2ViewController", @"UserViewController",@"SettingViewController", @"SettingViewController", @"SettingViewController"];
