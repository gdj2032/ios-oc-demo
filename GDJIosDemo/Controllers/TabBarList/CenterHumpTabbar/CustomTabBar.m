...
- (UIButton *)plusButton
{
    if (_plusButton == nil) {
        ...
        [_plusButton setTitle:@"扫一扫" forState:UIControlStateNormal];
        [_plusButton setTitle:@"扫一扫" forState:UIControlStateHighlighted];
...
//        CGFloat titleWidth = [_plusButton.titleLabel.text sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont boldSystemFontOfSize:11],NSFontAttributeName, nil]].width;
        ...
        [_plusButton setImageEdgeInsets:UIEdgeInsetsMake(-20, 0, 0, 0)];
...
- (void)layoutSubviews
{
    ...
    [dict setValue:@"gdj-home" forKey:@"name"];
    self.block(dict);
