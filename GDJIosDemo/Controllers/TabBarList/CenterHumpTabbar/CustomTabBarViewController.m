...
- (void)tabBarControllerAddChildViewController
{
    ...
    NSArray *classControllers = [NSArray array];
    classControllers = @[@"HomeViewController", @"UserViewController"];
    NSArray *titles = @[@"首页", @"我的"];
    NSArray *normalImages = @[@"home_normal", @"user_normal"];
    NSArray *selectImages = @[@"home_highlight", @"user_highlight"];
...
- (void)tabBarDidClickPlusButton:(CustomTabBar *)tabBar
{
    ...
    CenterViewController *vc = [CenterViewController new];
